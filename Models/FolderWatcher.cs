  ...
  public bool ProcessGDTFile(string path)
  {
    ...
    try
    {
      if (!FolderWatcher.FileGeneratedBySeca(path)){
        Logger.LogInformation("$The current file {path} is not generated by Seca and will therefor be skipped");
        return true;
      }
      Logger.LogInformation($"Reading gdt content from file {path}");
